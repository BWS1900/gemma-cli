...
describe('validateAuthMethod', () => {
  beforeEach(() => {
    vi.stubEnv('GEMMA_API_KEY', undefined);
  ...
  it.each([
    ...
    {
      description: 'should return null for USE_GEMINI if GEMMA_API_KEY is set',
      authType: AuthType.USE_GEMINI,
      envs: { GEMMA_API_KEY: 'test-key' },
      expected: null,
    },
    {
      description:
        'should return an error message for USE_GEMINI if GEMMA_API_KEY is not set',
      authType: AuthType.USE_GEMINI,
      envs: {},
      expected:
        'When using Gemini API, you must specify the GEMMA_API_KEY environment variable.\n' +
