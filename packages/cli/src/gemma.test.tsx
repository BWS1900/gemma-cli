...
describe('gemini.tsx main function', () => {
  ...
  beforeEach(() => {
    ...
    vi.stubEnv('GEMMA_CLI_TRUST_WORKSPACE', 'true');
...
describe('getNodeMemoryArgs', () => {
  ...
  beforeEach(() => {
    ...
    delete process.env['GEMMA_CLI_NO_RELAUNCH'];
  ...
  it('should return empty array if GEMMA_CLI_NO_RELAUNCH is set', () => {
    process.env['GEMMA_CLI_NO_RELAUNCH'] = 'true';
...
describe('gemini.tsx main function kitty protocol', () => {
  ...
  beforeEach(() => {
    ...
    originalEnvNoRelaunch = process.env['GEMMA_CLI_NO_RELAUNCH'];
    process.env['GEMMA_CLI_NO_RELAUNCH'] = 'true';
  ...
  afterEach(() => {
    ...
    if (originalEnvNoRelaunch !== undefined) {
      process.env['GEMMA_CLI_NO_RELAUNCH'] = originalEnvNoRelaunch;
    } else {
      delete process.env['GEMMA_CLI_NO_RELAUNCH'];
    }
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
