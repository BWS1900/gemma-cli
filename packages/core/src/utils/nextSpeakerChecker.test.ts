...
import { GemmaChat } from '../core/gemmaChat.js';
...
describe('checkNextSpeaker', () => {
  ...
  beforeEach(() => {
    ...
    // GemmaChat will receive the mocked instances via the mocked GoogleGenAI constructor
    chatInstance = new GemmaChat(
      mockConfig,
