...
/**
 * Decoupled LLM request format - stable across Gemma CLI versions
 */
...
/**
 * Decoupled LLM response format - stable across Gemma CLI versions
 */
...
/**
 * Decoupled tool configuration - stable across Gemma CLI versions
 */
