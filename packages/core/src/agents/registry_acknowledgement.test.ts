...
describe('AgentRegistry Acknowledgement', () => {
  ...
  beforeEach(async () => {
    ...
    // Override GEMMA_CLI_HOME to point to the temp directory
    originalGeminiCliHome = process.env['GEMMA_CLI_HOME'];
    process.env['GEMMA_CLI_HOME'] = tempDir;
  ...
  afterEach(async () => {
    ...
    if (originalGeminiCliHome) {
      process.env['GEMMA_CLI_HOME'] = originalGeminiCliHome;
    } else {
