...
// Mock GemmaClient and Config constructor
...
describe('WebSearchTool', () => {
  ...
  beforeEach(() => {
    ...
    mockGemmaClient = new GemmaClient(mockConfigInstance);
  ...
  describe('execute', () => {
    it('should return search results for a successful query', async () => {
      ...
      (mockGemmaClient.generateContent as Mock).mockResolvedValue({
        candidates: [
          {
            content: {
              role: 'model',
    ...
    it('should return a WEB_SEARCH_FAILED error on failure', async () => {
      ...
      (mockGemmaClient.generateContent as Mock).mockRejectedValue(testError);
        ...
        candidates: [
          {
            ...
            groundingMetadata: {
              groundingChunks: [
                ...
                {
                  web: {
                    title: 'Gemma CLI: your open-source AI agent',
              ...
              groundingSupports: [
                ...
                {
                  segment: {
                    // Byte range of "Gemma CLI✨️" (utf-8 encoded)
                    startIndex: 17,
                    endIndex: 33,
                  },
...
[3] Gemma CLI: your open-source AI agent (https://blog.google/technology/developers/introducing-gemini-cli-open-source-ai-agent/)`;
