...
const IDE_SERVER_PORT_ENV_VAR = 'GEMMA_CLI_IDE_SERVER_PORT';
const IDE_WORKSPACE_PATH_ENV_VAR = 'GEMMA_CLI_IDE_WORKSPACE_PATH';
const IDE_AUTH_TOKEN_ENV_VAR = 'GEMMA_CLI_IDE_AUTH_TOKEN';
